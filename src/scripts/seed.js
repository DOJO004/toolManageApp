...
export async function PostAddProductLineInfo() {
  for (let i = 0; i <= addProductLine.length; i++) {
    await apiAddProductLineInfo(
      addProductLine[i].ProductLineID,
      addProductLine[i].ProductLineName
    );
...
export async function PostAddMachineTypeInfo() {
  for (let i = 0; i <= addMachineTypeItem.length; i++) {
    await apiAddMachineTypeInfo(
      addMachineTypeItem[i].MachineTypeID,
      addMachineTypeItem[i].MachineTypeName
    );
